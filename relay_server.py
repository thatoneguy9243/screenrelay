"""
relay_server.py — sends frames as base64 to avoid binary mangling over HTTP
"""
...
def frame_b64():
    ...
    # Return as JSON so Lua can use JSONDecode safely
    return jsonify({"width": w, "height": h, "data": frame})
